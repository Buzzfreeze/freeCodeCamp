...
class `btn-primary` จะให้สีปุ่มที่เป็นสีหลักของแอปที่คุณสร้าง ซึ่งใช้ในการสื่อว่าปุ่มนี้เป็นปุ่มที่อยากให้ user กดนะ

ลองเปลี่ยน Bootstrap class ของปุ่มของคุณจาก `btn-default` เป็น `btn-primary` ดู
