...
ตอนนี้ ให้เราทำเช่นเดียวกันสำหรับส่วนของเส้น 5,000 เส้น ด้วยเหตุนี้ เราจึงสร้างตัวเลข 20000 เลขได้ โดยใช้วิธีสร้างตัวเลขสุ่มที่เรียกว่า "Blum Blum Shub"
...
ตัวเลขสี่ตัวแรกที่คำนวณตามวิธีสร้างข้างต้นควรเป็น 27, 144, 12 และ 232 ส่วนแรกจะเป็น (27, 144) ถึง (12, 232)

มีจุดตัดจริงที่แตกต่างกันกี่จุดในกลุ่มเส้น 5,000 เส้น

# --hints--

`distinctIntersections()` ต้องคืนค่าเป็น `2868868`
