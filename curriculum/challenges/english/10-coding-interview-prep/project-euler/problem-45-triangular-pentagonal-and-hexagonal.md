...
Triangle, pentagonal, and hexagonal numbers ได้มาจากสูตรด้านล่าง:
...
สามารถยืนยันได้ว่า T<sub>285</sub> = P<sub>165</sub> = H<sub>143</sub> = 40755.

หา triangle number ตัวถัดไปของ pentagonal และ hexagonal

# --hints--

`triPentaHexa(40756)` ควร return number.

```js
assert(typeof triPentaHexa(40756) === 'number');
```

`triPentaHexa(40756)` ควร return 1533776805.
