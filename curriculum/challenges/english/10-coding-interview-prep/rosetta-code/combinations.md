...
กำหนดจำนวนเต็มไม่เป็นลบ `m' และ `n' ให้สร้างขนาดทั้งหมดรวมกัน `m` ของจำนวนเต็มจาก `0' (ศูนย์) ถึง `n-1' ตามลำดับการจัดเรียง (แต่ละชุดจะถูกจัดเรียงและทั้งตารางถูกจัดเรียง ).
...
`combinations(3, 5)` ควร return `[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 2, 3], [0, 2, 4], [0, 3, 4], [1, 2, 3], [1, 2, 4], [1, 3, 4], [2, 3, 4]]`.

```js
assert.deepEqual(combinations(testInput1[0], testInput1[1]), testOutput1);
```

`combinations(4, 6)` ควร return `[[0,1,2,3], [0,1,2,4], [0,1,2,5], [0,1,3,4], [0,1,3,5], [0,1,4,5], [0,2,3,4], [0,2,3,5], [0,2,4,5], [0,3,4,5], [1,2,3,4], [1,2,3,5], [1,2,4,5], [1,3,4,5], [2,3,4,5]]`
